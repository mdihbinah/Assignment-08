            ...
            <div className="grid md:grid-cols-3 lg:grid-cols-4  gap-5 mt-5">
                {
                    featuredtiles.map(ele => {
                        return <div key={ele.id} className="flex flex-col justify-center items-center gap-5 border p-5 max-w-100 card text-center hover:shadow-2xl animate__animated animate__slideInUp animate__delay-1s animate__slow">
